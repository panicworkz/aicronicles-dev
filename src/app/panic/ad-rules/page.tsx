...
const BOLUMLER: { baslik: string; ikon: any; kurallar: Kural[] }[] = [
  ...
  },
  {
    ...
    kurallar: [
      ...
      { n: 18, metin: "Önce sitemap.xml'e bakılır.",
        neden: "AICall'ın menü bağlantıları çapa olduğu için tek sayfa sanılmıştı; site haritasında 79 sayfa çıktı." },
      { n: 19, metin: "Üç mesaj, her biri kendi sayfasına gider." },
      { n: 20, metin: "Üç açıklamanın kelime sayısı farkı en fazla 1 VE basılan genişlik sapması en fazla %8.",
        neden: "Yalnızca kelimeyi eşitlemek yetmez: bileşik kelimeler tek kelime sayılırken satırı iki katına çıkarır." },
      { n: 21, metin: "Ortadaki liste o an oynamayan söylemleri gösterir, numarasız." },
    ],
  },
  {
    baslik: "Logo",
    ikon: ImageIcon,
    kurallar: [
      { n: 22, metin: "Markanın sitedeki gerçek işareti kullanılır: resimse dosyası, yazıysa yazı olarak çizilir." },
      { n: 23, metin: "Yazı logosu düz basılır, sitede italik olsa bile." },
      { n: 24, metin: "Yazı logosu büyük harf yüksekliğine göre hizalanır (≈0.69 em).",
        neden: "Taban çizgisi katsayısıyla hizalayınca künye resim logolu markalardan 1–2 piksel ayrışıyordu." },
      { n: 25, metin: "Logo base64 ile afişin içine gömülür; dış bağımlılık yok." },
      { n: 26, metin: "Logosu olmayan marka kelime markasıyla basılır. Uydurma işaret yok." },
    ],
  },
  {
    baslik: "Hareket",
    ikon: Play,
    kurallar: [
      { n: 27, metin: "Künye sabittir — logo, alan adı, kural. Mesaj değişirken marka yanıp sönmez." },
      { n: 28, metin: "Perde 7 saniye; üç mesaj 21 saniyede döner." },
      { n: 29, metin: "Sıra: başlık → çağrı yazısı → altına çizgi → el belirir, arar, bulur, basar → çağrı vurgu rengine döner." },
      { n: 30, metin: "animation-fill-mode: backwards şarttır.",
        neden: "Yoksa gecikmeyi bekleyen perdeler kendi normal hallerini gösterir, üçü üst üste basılır." },
      { n: 31, metin: "Her keyframe karesinde opacity açıkça yazılır.",
        neden: "Yazılmazsa CSS aradaki değeri doldurur ve öge sinsice solar." },
      { n: 32, metin: "Konumlandırma dış grupta, animasyon iç grupta.",
        neden: "CSS transform'u nitelik transform'unu ezer; el afişin sol üst köşesine gidiyordu." },
      { n: 33, metin: "transform-origin kullanılmaz.",
        neden: "SVG'de varsayılan transform-box view-box olduğu için 'sol' afişin kenarını gösterir." },
      { n: 34, metin: "Hareket kapalıyken (prefers-reduced-motion) afiş tek mesaja düşer." },
      { n: 35, metin: "Yalnızca opacity ve transform. Yeniden yerleşim ya da boyama tetikleyen kare yok." },
      { n: 36, metin: "SVG içindeki style bloğunda < veya > olamaz; XML'i keser." },
    ],
  },
];
