    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-10 space-y-2">
          <span className="text-xs font-mono uppercase tracking-widest text-primary">Editorial Staff</span>
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground font-serif">
            {author?.name || 'Fabelo Editorial'}
          </h1>
          <p className="text-muted-foreground text-sm max-w-2xl">Editorial desk covering career, finance, headless tech and AI.</p>
        </div>
