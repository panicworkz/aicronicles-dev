    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 selection:bg-amber-500 selection:text-black">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-10 space-y-2">
          <span className="text-xs font-mono uppercase tracking-widest text-amber-500">Editorial Topic</span>
          <h1 className="text-4xl font-extrabold tracking-tight text-white font-serif capitalize">
            {tag?.name || slug.replace(/-/g, ' ')}
          </h1>
          <p className="text-neutral-400 text-sm max-w-2xl">{tag?.description || 'Curated guides and analysis.'}</p>
        </div>
